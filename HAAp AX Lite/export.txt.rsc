# 2024-10-13 17:26:24 by RouterOS 7.16.1
...
add name="4 Jam" rate-limit-burst-rx=5000000B rate-limit-burst-threshold-rx=\
    ...
    uptime-limit=4h
add download-limit=1000000000B name="24 Jam" rate-limit-burst-rx=3000000B \
...
add name="4 Jam" name-for-users="4 Jam" price=5000 starts-when=first-auth \
    validity=4h
add name="24 Jam" name-for-users="24 Jam" price=10000 starts-when=first-auth \
    validity=1d
...
/ip hotspot user
add name=DjCAdmin
add name=G@12r6z profile=Guest
/ip ipsec profile
...
add dont-require-permissions=no name=GlobalConfig owner=admin policy=\
    ...
    global BotID 21031676GANTI-DULU-YANG-BENARizhle0dh0;\r\
    \n:global ChatID 10GANTI22;\r\
...
add dont-require-permissions=no name=CleaningUM owner=admin policy=\
    ...
    \\\$\"];\r\
    \n# /user-manager/session/remove [find where user~\"^\\\\*[0-9a-fA-F]{1,8}\
    \\\$\"];\r\
...
add limitation="24 Jam" profile="24 Jam"
/user-manager router
